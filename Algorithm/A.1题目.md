...
## 7.[Parity Game](https://www.luogu.com.cn/problem/P5937)

这题使用的是**带权并查集**，还附带了**路径压缩算法**，即*让子节点直接连接在 Root* 上，而不是接在父节点上。这题做的时候没有思路，问豆包以后只是看明白了并查集部分，真正的解题算法还是不会。
...
本题使用了**差分+离散化**的思路，因为数据分布极其离散。

---

# 二十、最大化最小值

## 1. [P3017 [USACO11MAR] Brownie Slicing G - 洛谷](https://www.luogu.com.cn/problem/P3017)

这题是经典的**最大化最小值**问题，做的时候是让 AI 教的，不是很明白为什么。
